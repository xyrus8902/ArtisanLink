...
<body>
    ...
    <div class="row">
        <div class="col-lg-4 text-center">
            ...
            ?>
            <img src="<?php echo '../uploads/' . htmlspecialchars($profile_picture); ?>" class="rounded-circle shadow" alt="Profile Picture" style="width: 200px; height: 200px;">
            <hr class="mb-0">
        </div>
    ...
    <div class="col-md-6">
        ...
        <p><i class="fas fa-palette"></i> <strong>Art Style:</strong> 
            <?php 
            if (isset($user['art_style'])) {
                $art_styles = explode(',', $user['art_style']);
                echo htmlspecialchars(implode(', ', $art_styles));
            } else {
                echo "N/A";
            }
            ?>
        ...
        <p><i class="fas fa-exclamation-circle"></i> <strong>Exhibitions/Exposures:</strong> <?php echo isset($user['exhibitions_exposures']) ? htmlspecialchars($user['exhibitions_exposures']) : "N/A"; ?></p>
    </div>
</div>
